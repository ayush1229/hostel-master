...
echo "Seeding initial staff data..."
docker compose exec -T hostel-backend node scripts/seed-staff.js

echo "Deployment Complete! All services and test data are live."